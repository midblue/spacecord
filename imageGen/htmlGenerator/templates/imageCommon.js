var ui = (function () {
  ...
  /* imageGen/htmlGenerator/src/imageCommon.svelte generated by Svelte v3.32.3 */
  ...
  function create_fragment(ctx) {
  	...
  	return {
  		c() {
  			div = element("div");
  			svg = svg_element("svg");
  			attr(svg, "viewBox", "" + (/*view*/ ctx[0].left + " " + /*view*/ ctx[0].top + " " + /*view*/ ctx[0].right + " " + /*view*/ ctx[0].bottom));
  ...
  function instance($$self) {
  	...
  	const view = { left: 0, top: 0, right: 1, bottom: 1 };

  	function redraw(data) {
  		data.guilds.map(g => g.ship);
  		data.planets;
  		data.caches;
  		data.attackRemnants;
  	}
  ...
  class ImageCommon extends SvelteComponent {
  	constructor(options) {
  		super();
