var ui = (function () {
  ...
  /* imageGen/htmlGenerator/src/map.svelte generated by Svelte v3.32.3 */
  ...
  // (91:2) {#each pointsToShow.filter((p) => p.radius) as p}
  function create_each_block$1(ctx) {
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			const mapplanet_changes = (dirty & /*pointsToShow*/ 1)
  ...
  // (89:0) <Box label={'Discovered Planets'}>
  function create_default_slot(ctx) {
  	...
  	mapdistancecircles = new MapDistanceCircles({
  			props: {
  				centerPoint: /*shipPoint*/ ctx[2],
  				diameter: /*displayDiameter*/ ctx[1]
  			}
  		});

  	let each_value = /*pointsToShow*/ ctx[0].filter(func);
  	let each_blocks = [];
  	...
  	const mappoint_spread_levels = [/*shipPoint*/ ctx[2]];
  	let mappoint_props = {};
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			if (dirty & /*pointsToShow*/ 1) {
  				each_value = /*pointsToShow*/ ctx[0].filter(func);
  				let i;
  			...
  			const mappoint_changes = (dirty & /*shipPoint*/ 4)
  			? get_spread_update(mappoint_spread_levels, [get_spread_object(/*shipPoint*/ ctx[2])])
  			: {};
  ...
  function create_fragment$5(ctx) {
  	...
  	return {
  		...
  		p(ctx, [dirty]) {
  			...
  			if (dirty & /*$$scope, pointsToShow*/ 262145) {
  ...
  function instance$5($$self, $$props, $$invalidate) {
  	...
  	pointsToShow = pointsToShow.map(p => {
  		console.log("tp", (upperBound + bufferDistance / 2 - p.location[1]) / displayDiameter, leftBound, (p.location[0] - (leftBound - bufferDistance / 2)) / displayDiameter);
  	...
  	return [pointsToShow, displayDiameter, shipPoint];
  }
