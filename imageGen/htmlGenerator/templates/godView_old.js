var ui = (function () {
  ...
  class MapDistanceCircles extends SvelteComponent {
  	constructor(options) {
  		super();
  		init(this, options, instance$4, create_fragment$4, safe_not_equal, { centerPoint: 1, diameter: 2 });
  	}
  }
  ...
  var css_248z$5 = ":root{--main-width:100%;--main-height:100%;--text-size:14px}.holder.svelte-u9unry{--main-width:100%;--main-height:100%;--text-size:14px;width:100%;height:100%}";
  styleInject(css_248z$5);

  /* imageGen/htmlGenerator/src/godView_old.svelte generated by Svelte v3.32.3 */
  ...
  function create_if_block$3(ctx) {
  	...
  	mapdistancecircles = new MapDistanceCircles({
  			props: {
  				...
  				diameter: /*displayDiameter*/ ctx[0]
  			}
  		});
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			const mapdistancecircles_changes = {};
  			if (dirty & /*displayDiameter*/ 1) mapdistancecircles_changes.diameter = /*displayDiameter*/ ctx[0];
  			mapdistancecircles.$set(mapdistancecircles_changes);
  		},
  		i(local) {
  			if (current) return;
  ...
  // (131:4) {#each pointsToShow.filter((p) => p.radius) as p}
  function create_each_block_1(ctx) {
  	let mapplanet;
  	let current;
  	const mapplanet_spread_levels = [/*p*/ ctx[11]];
  	let mapplanet_props = {};
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			const mapplanet_changes = (dirty & /*pointsToShow*/ 2)
  			? get_spread_update(mapplanet_spread_levels, [get_spread_object(/*p*/ ctx[11])])
  			: {};
  ...
  // (134:4) {#each pointsToShow.filter((p) => !p.radius) as p}
  function create_each_block$1(ctx) {
  	let mappoint;
  	let current;
  	const mappoint_spread_levels = [/*p*/ ctx[11]];
  	let mappoint_props = {};
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			const mappoint_changes = (dirty & /*pointsToShow*/ 2)
  			? get_spread_update(mappoint_spread_levels, [get_spread_object(/*p*/ ctx[11])])
  			: {};
  ...
  // (124:2) <Box label={'Game View'} bind:this={mapContainer}>
  function create_default_slot(ctx) {
  	let t0;
  	let t1;
  	let each1_anchor;
  	let current;
  	let if_block = /*displayDiameter*/ ctx[0] && create_if_block$3(ctx);
  	let each_value_1 = /*pointsToShow*/ ctx[1].filter(func);
  	let each_blocks_1 = [];
  	...
  	let each_value = /*pointsToShow*/ ctx[1].filter(func_1);
  	let each_blocks = [];
  	...
  	return {
  		...
  		p(ctx, dirty) {
  			if (/*displayDiameter*/ ctx[0]) {
  				if (if_block) {
  					if_block.p(ctx, dirty);

  					if (dirty & /*displayDiameter*/ 1) {
  			...
  			if (dirty & /*pointsToShow*/ 2) {
  				each_value_1 = /*pointsToShow*/ ctx[1].filter(func);
  				let i;
  			...
  			if (dirty & /*pointsToShow*/ 2) {
  				each_value = /*pointsToShow*/ ctx[1].filter(func_1);
  				let i;
  ...
  function create_fragment$6(ctx) {
  	...
  	return {
  		c() {
  			...
  			attr(div, "class", "holder svelte-u9unry");
  		},
  		m(target, anchor) {
  			insert(target, div, anchor);
  			mount_component(starfield, div, null);
  			append(div, t);
  		...
  		p(ctx, [dirty]) {
  			...
  			if (dirty & /*$$scope, pointsToShow, displayDiameter*/ 65539) {
  		...
  		d(detaching) {
  			if (detaching) detach(div);
  			destroy_component(starfield);
  			/*box_binding*/ ctx[3](null);
  ...
  const func = p => p.radius;
  const func_1 = p => !p.radius;
  ...
  function instance$6($$self, $$props, $$invalidate) {
  	...
  	function redraw(data) {
  		...
  		$$invalidate(1, pointsToShow = [
  			...
  			...attackRemnants.map(p => ({ location: p.location, color: "red" }))
  		]);
  		...
  		$$invalidate(0, displayDiameter = diameter + bufferDistance);
  		...
  		$$invalidate(1, pointsToShow = pointsToShow.map(p => {
  			return {
  				...p,
  				label: p.name,
  	...
  	function box_binding($$value) {
  		binding_callbacks[$$value ? "unshift" : "push"](() => {
  			mapContainer = $$value;
  			$$invalidate(2, mapContainer);
  		});
  	}

  	return [displayDiameter, pointsToShow, mapContainer, box_binding];
  }

  class GodView_old extends SvelteComponent {
  	constructor(options) {
  		super();
