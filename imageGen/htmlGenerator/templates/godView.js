var ui = (function () {
  ...
  function create_fragment$2(ctx) {
  	...
  	let mounted;
  	let dispose;
  	let if_block = /*name*/ ctx[4] && /*scale*/ ctx[7] >= 0.9 && create_if_block$1(ctx);
  ...
  var css_248z$6 = "g.svelte-16harj0{z-index:10;position:relative}line.svelte-16harj0{opacity:0.1}text.svelte-16harj0{opacity:0.3;font-weight:bold}";
  ...
  var css_248z$7 = "circle.svelte-12jfefv{opacity:0.6}text.svelte-12jfefv{text-transform:uppercase;font-weight:bold}";
  ...
  class DistanceCircles extends SvelteComponent {
  	constructor(options) {
  		super();
  		init(this, options, instance$a, create_fragment$a, safe_not_equal, { width: 2, height: 3, location: 0 });
  	}
  }

  var css_248z$8 = ".holder.svelte-1yvaa8k{width:100%;height:100%;position:relative;z-index:2;user-select:none}svg.svelte-1yvaa8k{width:100%;height:100%}";
  ...
  function create_fragment$b(ctx) {
  	...
  	let if_block0 = !/*gameData*/ ctx[0]?.center && create_if_block_2$1(ctx);
  	let if_block1 = /*gameData*/ ctx[0]?.center && create_if_block_1$1(ctx);
  	let if_block2 = /*gameData*/ ctx[0]?.radius && create_if_block$3(ctx);
  ...
  class MapViewer extends SvelteComponent {
  	constructor(options) {
  		super();
  		init(this, options, instance$b, create_fragment$b, safe_not_equal, { gameData: 0 });
  	}
  }

  var css_248z$9 = ".holder.svelte-55sgxr{width:100%;height:100%;--text-size:12px}";
  ...
  function create_fragment$c(ctx) {
  	...
  	return {
  		c() {
  			...
  			attr(div, "class", "holder svelte-55sgxr");
  		},
  		m(target, anchor) {
  			insert(target, div, anchor);
  			mount_component(mapviewer, div, null);
  			current = true;
  		},
  		p(ctx, [dirty]) {
  			const mapviewer_changes = {};
  			if (dirty & /*gameData*/ 1) mapviewer_changes.gameData = /*gameData*/ ctx[0];
  			mapviewer.$set(mapviewer_changes);
  		},
  		i(local) {
  			if (current) return;
  ...
  function instance$c($$self, $$props, $$invalidate) {
  	...
  	if (!gameData) {
  		async function getGameData() {
  			...
  			$$invalidate(0, gameData = await res.json());
  		} // console.log(gameData)
